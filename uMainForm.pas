...
begin
  ...
  .Replace('%base64%','"'+MemoryStreamToBase64(LMS)+'"')
...
begin
  ...
  begin
    ...
    begin
      ...
      var LSketchFilename := ExtractFilePath(ParamStr(0)) + LHash + '_sketch.png';
      FPaintBox.SaveToFile(LSketchFileName);
...
begin
  ...
  FPaintBox.LoadFromFile(ImagePathEdit.Text.Replace('.png','_sketch.png'));
